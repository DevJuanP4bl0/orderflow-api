...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2025-09-21T03:42:10Z"), OrderStatus.WAITING_PAYMENT, u2); 
		...
		Payment p01 = new Payment(null, Instant.parse("2025-08-20T21:53:07Z"), o1);
		o1.setPayment(p01);
